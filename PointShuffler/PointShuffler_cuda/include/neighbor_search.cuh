    ...
    cudaStream_t stream)
{
    ...
    cudaEventElapsedTime(pre_search_time, start, stop);
    ...
    cudaEventRecord(stop, stream);
    cudaEventSynchronize(stop);
    cudaEventElapsedTime(neighbor_search_time, start, stop);  
    ...
    cudaEventRecord(stop, stream);
    cudaEventSynchronize(stop);
    cudaEventElapsedTime(common_neighbor_search_time, start, stop);  
