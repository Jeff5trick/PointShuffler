...
int main(int argc, char *argv[]) {
    ...
    std::string point_path = "../data/modelnet40_layer1_feat.txt";
    std::string feature_path = "../data/modelnet40_layer1_feat.txt";
    ...
    for(int i=1; i<50; i++)
    {
        ...
        write_times_to_csv(times, "../layer1_cuda.csv",n,m,K,r,block_size,hop);
        cudaDeviceSynchronize();
    }
}
